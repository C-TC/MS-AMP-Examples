#!/bin/bash -l
#SBATCH --job-name="pretrain_te_345m"
...
CHECKPOINT_PATH=${BASE_PATH}/checkpoints/gpt_345m_te
LOG_PATH=${BASE_PATH}/logs/gpt_345m_te.log
TENSORBOARD_PATH=${BASE_PATH}/tensorboard/gpt_345m_te
