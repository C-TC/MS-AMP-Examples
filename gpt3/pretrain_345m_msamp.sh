#!/bin/bash -l
#SBATCH --job-name="pretrain_msamp_345m"
...
CHECKPOINT_PATH=${BASE_PATH}/checkpoints/gpt_345m_msamp
LOG_PATH=${BASE_PATH}/logs/gpt_345m_msamp.log
TENSORBOARD_PATH=${BASE_PATH}/tensorboard/gpt_345m_msamp
